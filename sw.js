 ...
 */
const CACHE_NAME = 'mantilla-v1.3.155';
...
const PRECACHE_URLS = [
  ...
  './css/components/buttons.css?v=3',
  ...
  './css/components/bottom-nav.css?v=32',
  ...
  './js/services/drafts.js?v=5',
  './js/services/activity.js?v=2',
  './js/services/render.js?v=23',
  ...
  './js/pages/mantenimiento.js?v=27',
  './js/pages/ingresos-extras.js?v=4',
  './js/pages/viajes.js?v=96',
  './js/offline.js?v=3',
  './js/app.js?v=39',
  './js/pwa.js?v=14'
];
...
self.addEventListener('fetch', (event) => {
  ...
  // Navegación interna: mostrar caché al instante y actualizar en segundo plano.
  if (isSpaPage) {
